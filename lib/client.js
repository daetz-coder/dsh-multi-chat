...
//#endregion
//#region \0dsh-css:D:\2026AppDev\dsh-plugins-multi-task\src\client\WallView.module.css.mjs
const css$1 = "[data-conversation-scroll]:has([data-wall-view]) [data-composer-seat]{display:none}.sRUrTW_wall{background:var(--dsw-alias-bg-base);min-width:0;min-height:0;color:var(--dsw-alias-label-primary);flex-direction:column;flex:1;display:flex}.sRUrTW_toolbar{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);flex-wrap:wrap;flex:none;align-items:center;gap:12px;padding:8px 14px;display:flex}.sRUrTW_title{font-size:14px;font-weight:600}.sRUrTW_linkBar{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-wrap:wrap;flex:none;align-items:center;gap:10px;padding:6px 14px;display:flex}.sRUrTW_linkText{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere;flex:1;min-width:160px;font-size:12px}.sRUrTW_status{color:var(--dsw-alias-label-secondary);flex:1;min-width:120px;font-size:12px}.sRUrTW_controls{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.sRUrTW_field{color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:12px;display:inline-flex}.sRUrTW_field>span{width:76px}.sRUrTW_grid{flex:1;grid-auto-rows:minmax(280px,1fr);align-content:start;gap:8px;padding:8px;display:grid;overflow:auto}.sRUrTW_grid[data-cols=auto]{grid-template-columns:repeat(auto-fit,minmax(280px,1fr))}.sRUrTW_grid[data-cols=\"1\"]{grid-template-columns:1fr}.sRUrTW_grid[data-cols=\"2\"]{grid-template-columns:repeat(2,1fr)}.sRUrTW_grid[data-cols=\"3\"]{grid-template-columns:repeat(3,1fr)}.sRUrTW_grid[data-cols=\"4\"]{grid-template-columns:repeat(4,1fr)}.sRUrTW_grid[data-cols=\"6\"]{grid-template-columns:repeat(6,1fr)}.sRUrTW_pane{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:8px;flex-direction:column;min-width:0;min-height:0;display:flex;overflow:hidden}.sRUrTW_pane.sRUrTW_zoomed{grid-area:1/1/-1/-1}.sRUrTW_paneHead{border-bottom:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);flex:none;align-items:center;gap:8px;padding:4px 8px;display:flex}.sRUrTW_dot{flex:none}.sRUrTW_paneTitle{text-overflow:ellipsis;white-space:nowrap;font-size:12px;overflow:hidden}.sRUrTW_paneActions{flex:none;gap:2px;margin-left:auto;display:flex}.sRUrTW_action{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:4px;padding:2px 6px;line-height:1}.sRUrTW_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.sRUrTW_action.sRUrTW_danger:hover{color:var(--dsw-static-amber-600)}.sRUrTW_action.sRUrTW_danger.sRUrTW_confirm{background:var(--dsw-static-amber-500);color:var(--dsw-static-neutral-00);padding:2px 8px;font-size:11px}.sRUrTW_action.sRUrTW_danger.sRUrTW_confirm:hover{background:var(--dsw-static-amber-600);color:var(--dsw-static-neutral-00)}.sRUrTW_paneBody{flex:1;min-height:0;position:relative}.sRUrTW_paneBody iframe{border:none;width:100%;height:100%;display:block}.sRUrTW_empty{color:var(--dsw-alias-label-secondary);flex-direction:column;grid-column:1/-1;justify-content:center;align-items:center;gap:6px;display:flex}.sRUrTW_empty .sRUrTW_hint{font-size:12px}";
...
var WallView_module_css_default = {
	"danger": "sRUrTW_danger",
	"wall": "sRUrTW_wall",
	"hint": "sRUrTW_hint",
	"pane": "sRUrTW_pane",
	"linkBar": "sRUrTW_linkBar",
	"paneBody": "sRUrTW_paneBody",
	"paneActions": "sRUrTW_paneActions",
	"title": "sRUrTW_title",
	"linkText": "sRUrTW_linkText",
	"toolbar": "sRUrTW_toolbar",
	"paneHead": "sRUrTW_paneHead",
	"zoomed": "sRUrTW_zoomed",
	"action": "sRUrTW_action",
	"empty": "sRUrTW_empty",
	"controls": "sRUrTW_controls",
	"field": "sRUrTW_field",
	"grid": "sRUrTW_grid",
	"paneTitle": "sRUrTW_paneTitle",
	"dot": "sRUrTW_dot",
	"status": "sRUrTW_status",
	"confirm": "sRUrTW_confirm"
};
...
//#endregion
//#region \0dsh-css:D:\2026AppDev\dsh-plugins-multi-task\src\client\WallToggle.module.css.mjs
const css = ".i1n9BW_row{box-sizing:border-box;width:calc(100% + 8px);height:34px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;margin:4px -4px;padding:6px 2px 6px 10px;display:flex;overflow:hidden}.i1n9BW_row:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.i1n9BW_label{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}";
